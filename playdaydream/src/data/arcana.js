...
export const VoiceStyles = {
  WHISPER:     { id: 'whisper',     name: 'The Whisper',     desc: 'Soft, intimate, close to the ear.' },
  BARD:        { id: 'bard',        name: 'The Bard',        desc: 'Poetic, rhythmic, story-driven.' },
  SAGE:        { id: 'sage',        name: 'The Sage',        desc: 'Measured, Socratic, contemplative.' },
  COMPANION:   { id: 'companion',   name: 'The Companion',   desc: 'Warm, encouraging, conversational.' },
  TRICKSTER:   { id: 'trickster',   name: 'The Trickster',   desc: 'Playful, unexpected, witty.' },
};
