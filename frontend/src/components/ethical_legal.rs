...
use leptos::prelude::*;
#[component]
pub fn EthicsConstraintsChallenge() -> impl IntoView {
    view! {
    ...
    <span class="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-bold uppercase tracking-widest border border-emerald-500/30">"Organizational Constraints"</span>
...
"This strategic document analyzes Purdue Policy I.A.1
to navigate the complex legal landscape of intellectual property (IP).
It proposes a formal 'University Partnership' where the Daydream platform is donated to Purdue, transforming a potential legal constraint (IP ownership) into a collaborative advantage (University sponsorship and resource allocation)."
    </p>
    </div>
    ...
    <div class="bg-slate-900/50 rounded-lg p-4 border border-white/5 mb-6 flex-grow">
    <p class="text-slate-300 text-sm leading-relaxed italic">
"A critical analysis of the 'Audit Culture' in modern professional practice.
This report reframes the consultant's role from a branded 'expert' to a dialogic 'partner,' establishing the ethical foundation for the Daydream project's focus on learner autonomy, transparency, and the 'gift' ethos of open-source collaboration."
    </p>
    </div>
    <div class="flex justify-start">
    ...
    <p> "These artifacts demonstrate my ability to
recognize, respect, and comply with complex <strong class='text-white'>organizational and legal constraints</strong> not by avoiding them, but by integrating them into the project's strategic architecture.
In analyzing <span class='text-emerald-300 font-medium'>Purdue Policy I.A.1 (Intellectual Property)</span>, I identified that the university's ownership claim to the 'Daydream' code was not a barrier, but a vehicle for sustainability.
By formally disclosing the IP and proposing a donation model, I aligned the project's 'gift ethos' with the university's research mission, transforming a potential conflict into a structured <span class='text-emerald-300 font-medium'>University Partnership</span>."
    ...
    <p> "Furthermore, the project's technical architecture (Local-First, Rust-Based) was designed as a direct response to the political and legal constraints of data privacy (COPPA/GDPR).
By rejecting 'black box' proprietary models in favor of transparent, auditable code, I demonstrated that compliance is not just a checklist, but an active design practice.
This approach proves that navigating organizational constraints requires <span class='text-emerald-300 font-medium'>Phronesis (Practical Wisdom)</span>—the ability to harmonize institutional policy with professional integrity to create systems that are both legally robust and ethically sound."
    </p>
    </div>
    </div>
    </div>
